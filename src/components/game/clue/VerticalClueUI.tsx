...
export const VerticalClueUI: React.FC<VerticalClueProps> = ({ clue, onHover, isHighlighted, onDiscard, isBinned }) => {
  ...
  return (
    <div 
      className={`w-16 h-28 bg-slate-800 dark:bg-slate-950 rounded-lg shadow-md hover:border-indigo-500 group transition-all duration-200 flex items-center justify-center shrink-0 select-none touch-none ${
        isHighlighted
